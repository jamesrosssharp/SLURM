...
#define SLRM_STIX_INSTRUCTION			0b0000001000000000
#define SLRM_STIX_INSTRUCTION_MASK		0b1111111100000000

#define SLRM_RSIX_INSTRUCTION			0b0000001100000000
#define SLRM_RSIX_INSTRUCTION_MASK		0b1111111100000000
...
#define SLRM_REG_TO_EXREG_ALU_INSTRUCTION	0b0110000000000000
#define SLRM_REG_TO_EXREG_ALU_INSTRUCTION_MASK	0b1111100000000000

#define SLRM_EXREG_TO_REG_ALU_INSTRUCTION	0b0110100000000000
#define SLRM_EXREG_TO_REG_ALU_INSTRUCTION_MASK	0b1111100000000000

// Instruction Class 7

#define SLRM_LD_EX_INSTRUCTION		0b0111000000000000
#define SLRM_LD_EX_INSTRUCTION_MASK	0b1111000000000111

#define SLRM_LDB_EX_INSTRUCTION		0b0111000000000001
#define SLRM_LDB_EX_INSTRUCTION_MASK	0b1111000000000111

#define SLRM_LDBSX_EX_INSTRUCTION	0b0111000000000010
#define SLRM_LDBSX_EX_INSTRUCTION_MASK	0b1111000000000110

#define SLRM_ST_EX_INSTRUCTION		0b0111000000000100
#define SLRM_ST_EX_INSTRUCTION_MASK	0b1111000000000111

#define SLRM_STB_EX_INSTRUCTION		0b0111000000000110
#define SLRM_STB_EX_INSTRUCTION_MASK	0b1111000000000110
