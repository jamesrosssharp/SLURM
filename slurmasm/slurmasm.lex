...
\.org|\.align|dw|dd|db|\.padto|\.global {yylval.pseudoopval = strdup(yytext); return PSEUDOOP; }
...
adc|add|and|asr|ba|bc|bl|bnc|bns|bnz|bs|bz|bv|bnv|cc|cs|cz|imm|iret|ld|lsl|lsr|mov|nop|or|ret|rol|rolc|rorc|sbb|sc|ss|st|sub|sz|xor|cmp|test|inc|dec|in|out|sleep|sti|cli|stf|rsf|mul|mulu|umulu|bne|beq|bge|blt|ble|bgt|ldb|ldbsx|stb|bltu|bleu|bgtu|bgeu { yylval.sval = strdup(yytext); return OPCODE; }
